...
'frame-mexico':['confetti'],
'frame-muertos':['petals'],
'frame-newyear':['sparkles'],
'frame-valentine':['hearts'],
'frame-dia-madre':['petals','hearts'],
'frame-dia-padre':['sparkles'],
'frame-navidad-nieve':['snow','sparkles'],
'frame-reyes':['sparkles'],
'frame-dia-nino':['confetti','candy'],
'frame-primavera':['petals'],
'frame-verano':['sparkles'],
'frame-regreso-clases':['sparkles'],
'frame-revolucion':['confetti'],
'frame-posadas':['confetti','petals'],
'frame-cumpleanos':['confetti','candy'],
'frame-aniversario':['hearts','sparkles'],
'frame-luna':['sparkles'],
'frame-fuego':['flames']
};
